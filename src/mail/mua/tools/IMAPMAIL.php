...
*/
	...
	class IMAPMAIL
	{
		...
		public function open_mailbox($mailbox_name="INBOX",$read_only=false)
		{
			if($read_only)
			{
		...
		public function get_unseen_msglist()
		{
			return $this->get_list(HKC_UNSEEN_MSG);
		}
		//function returns the number of recent messages
		public function get_recent_msglist()
		{
		...
		public function get_message_body($msgno,$uid=false)
		{
			if($uid)
		...
		//function retrives the full message from server.
		public function get_message_header($msgno,$uid=false)
		{
			if($uid)
		...
		//function retrives the full message from server.
		public function get_message($msgno,$uid=false)
		{
			if($uid)
		...
		public function delete_message($msgno)
		{
		...
		public function rollback_delete($msgno)
		{
			$this->must_update=true;
			return $this->store_mail_flag($msgno,"-Flags","\\Deleted" );
	...
	the connection. */
		...
		public function authenticate($auth_str,$ans_str1="",$ans_str2="")
		{
			if($this->state=="DISCONNECTED")
			{
				$this->error= "Error : No Connection Found!<br>";
	...
	mailbox can be accessed. */
		...
		public function examin_mailbox($mailbox_name)
			{
		if($this->state=="AUTHORIZATION")
		{
			$this->error= "Error : User is not authorised or logged in.!<br>";
		...
		public function subscribe_mailbox($mailbox_name)
		{
			if($this->state=="AUTHORIZATION")
			{
				$this->error= "Error : User is not authorised or logged in.!<br>";
		...
		server's set of "active" or "subscribed" mailboxes */
		public function unsubscribe_mailbox($mailbox_name)
		{
			if($this->state=="AUTHORIZATION")
			{
				$this->error= "Error : User is not authorised or logged in.!<br>";
	 ...
	 */
		public function list_mailbox($ref_mail_box="",$wild_card="*")
		{
			if($this->state=="AUTHORIZATION")
			{
				$this->error= "Error : User is not authorised or logged in.!<br>";
		...
		public function list_subscribed_mailbox($ref_mail_box="",$wild_card="*")
		{
			if($this->state=="AUTHORIZATION")
			{
				$this->error= "Error : User is not authorised or logged in.!<br>";
		...
		//function is same as list_mailbox rather than it returns active mail box list
		public function get_status($mail_box,$status_cmd)
		{
			if($this->state=="AUTHORIZATION")
			{
				$this->error= "Error : User is not authorised or logged in.!<br>";
	...
	responses are sent.
		*/
		...
		public function  expunge_mailbox()
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		*/
		...
		public function search_mailbox($search_cri,$charset="")
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		*/
		...
		public function uid_search_mailbox($search_cri,$charset="")
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		*/
		...
		public function  fetch_mail($msg_set,$msg_data_name)
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		*/
		...
		public function  uid_fetch_mail($msg_set,$msg_data_name)
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		*/
		...
		public function  store_mail_flag($msg_set,$msg_data_name,$value)
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		*/
		...
		public function  uid_store_mail_flag($msg_set,$msg_data_name,$value)
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		public function  copy_mail($msg_set,$mailbox)
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
		...
		*/
		...
		public function  uid_copy_mail($msg_set,$mailbox)
		{
			if($this->state!="SELECTED")
			{
				$this->error= "Error : No mail box is selected.!<br>";
